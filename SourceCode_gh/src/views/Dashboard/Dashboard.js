    ...
    const onArrange = (layout) => {
        ...
        if (viewSize == 'lg') {
            ...
            arrayArrange1_1.map(item => {
                ...
                if (iy > 1) {
                    console.log("intoIFl", "iy:", iy, "ix:", ix)

                    if (iy%2 != 0 && iy-1 > iyPrev) {
                    // if (iy-1 > iyPrev) {
                        console.log("iyPrev:", iyPrev, iy)
                        arrayArrange.push({ w: item.status.w, h: item.status.h, x: 8, y: iyPrev, i: item.id, moved: false, static: false })
                        iyPrev++;

                    // }
                   
                    }
                    else if (iy%2 == 0 && iy-1 >= iyPrev) {
                        // if (iy-1 >= iyPrev) {
                            arrayArrange.push({ w: item.status.w, h: item.status.h, x: 8, y: iyPrev, i: item.id, moved: false, static: false })
                            iyPrev++;
                        // }
                        ...
                        console.log("intoELSE", "iy:", iy, "ix:", ix)
        ...
        onLayoutChange(layout, objectArrange)
