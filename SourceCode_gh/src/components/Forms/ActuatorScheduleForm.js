...
const ActuatorScheduleForm = ({onCancel, handler, automationData, actuators, sensors, errors}) => {
    ...
    const scheduleOptions = [
        {label:  `${t("text.once")}` , value: "ONCE"},
        {label:  `${t("text.hour")}`  , value: "HOURLY"},
        {label:  `${t("text.Daily")}`  , value: "DAILY"},
        {label:  `${t("text.weekly")}`  , value: "WEEKLY"},
        {label:  `${t("text.monthly")}`   , value: "MONTHLY"},
        {label:  `${t("text.seasonal")}`   , value: "SEASONALLY"},
        {label:  `${t("text.yearly")}`   , value: "YEARLY"}
    ]
    ...
    const handleCreateAutomationRegulation = () => {
        const selectedConditionContentType = conditionContentTypes.find(item => item.model === selectedSensor?.item?.type?.value.toLowerCase());
    ...
    return (<>
            <div className="row header-schedule-form p-2 bold mx-0">
                <div
                    ...
                    onClick={() => setAutomationType("schedule")}>{t("text.Performanceschedule")} </div>
                <div
                    ...
                    onClick={() => setAutomationType("regulation")}>{t("text.Performancesensorreadings")}
                </div>
            </div>
                    ...
                    automationType === "schedule" ? (<>
                        <div className={`row mx-0 mb-1`}>
                            <div className={`col-lg-7 col-sm-12 px-0 ${isMobile ? "mt-4" : "mt-3"}`}>
                                <div className="form-group">
                                    <label className="required">{t("text.Defineyourfunctionname")}</label>
                                    <input
                                        type="text"
                                        className={`form-control pr-3 ${errors && errors?.title ? "border-error" : ""}`}
                                        placeholder= {t("text.Choosedesirednameforstatus")}
                                        value={title}
                                        ref={inputRef}
                        ...
                        <div className="row mx-0 mt-3">
                            <div className="col-12 border rounded-12 px-3 position-relative">
                                <span className="title">{t("text.if")}</span>
                                <div className={`col-lg-12 col-sm-12 mt-3 ${isMobile ? "px-0" : ""}`}>
                                    <div className="form-group">
                                        <label className="required">{t("text.scheduling")}</label>
                        ...
                        <div className="row mt-4 pt-3 mx-0">
                            <div className="col-12 border rounded-12 position-relative pr-3">
                                <span className="title">{t("text.then")}</span>
                                    ...
                                    <div className={`d-flex ${isMobile ? "flex-column align-items-stretch" : "align-items-center"}`}>
                                        ...
                                        <div className={`d-flex justify-content-between position-relative flex-grow-1 pl-0 ${isMobile ? "flex-wrap mt-4" : "pr-3 mr-5"}`}>
                                            <label className={`container-radio ${isMobile ? "col-6 mb-1" : ""}`}>
                                                ...
                                                <span className="radio-text">{t("text.on")}</span>
                                            </label>
                                            <label className={`container-radio ${isMobile ? "col-6 mb-1" : ""}`}>
                                                <input type="radio" name="statusRelay" value="OFF"
                                                       ...
                                                       onChange={e => setStatusRelaySchedule(e.target.value)}/>
                                                <span className="radio-mark"/>
                                                <span className="radio-text">{t("text.off")}</span>
                                            </label>
                                            <label className={`container-radio ${isMobile ? "col-6 mt-3" : ""}`}>
                                                <input type="radio" name="statusRelay" value="SWITCH"
                                                       ...
                                                       onChange={e => setStatusRelaySchedule(e.target.value)}/>
                                                <span className="radio-mark"/>
                                                <span className="radio-text">{t("text.switching")}</span>
                                            </label>
                                            {
                        ...
                        <div className="row mt-3 mx-0">
                            <div
                                ...
                                <div className={`row ${isMobile ? "justify-content-between" : "pl-2"}`}>
                                    <label
                                        className={`container-checkbox col-lg-6 d-flex align-items-center mb-0`}>
                                        <input type="checkbox" name="automation" checked={delay}
                                               onChange={e => setDelay(e.target.checked)}/>
                                        <span className="checkmark"/>
                                        <span
                                            className="radio-text text-wrap">{t("text.Thereistimedelayoperationrelay")}</span>
                                    </label>
                                    <div className={`px-0 col-lg-6 ${isMobile ? "col-12 mt-3" : ""}`}>
                                        <input
                                            type="number"
                                            value={delayValue}
                                            onChange={(e) => setDelayValue(e.target.value)}
                                            className="form-control pr-3"
                                            placeholder={t("text.Entertimedelayminutes")}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={`row ${isMobile ? "mt-2" : " mt-4"}`}>
                            <div className={`col-12 text-left ${isMobile ? "px-3" : "px-0 pt-3"}`}>
                                <Button
                                    ...
                                    className={`button btn-primary-fill py-2 px-5 d-flex- align-items-center justify-content-center ${isMobile ? "width-65" : ""} ${!validationFormSchedule ? "" : ""}`}><span                                    className="p-2">{t("text.confirm")}</span></Button>
                                <Button
                                    ...
                                    handler={onCancel}>
                                    <span className="p-2">{t('text.cancel')}</span>
                                </Button>
                            </div>
                        </div>
                    </>) : null
...

                {
                    automationType === "regulation" ? (<>
                        <div className="row mx-0 mb-1">
                            <div className={`col-lg-7 col-sm-12 px-0 ${isMobile ? "mt-4" : "mt-3"}`}>
                                <div className="form-group">
                                    <label>{t("text.Defineyourfunctionname")}</label>
                                    <input
                                        type="text"
                                        className={`form-control pr-3 ${errors && errors?.title ? "border-error" : ""}`}
                                        value={title}
                        ...
                        <div className="row mx-0 mt-3">
                            <div className="col-12 border rounded-12 px-3 position-relative">
                                ...
                                <div className={`col-lg-12 col-sm-12 mt-3 ${isMobile ? "px-0" : ""}`}>
                                    <div className="form-group">
                                        <label>{t("text.Sensorselection")}</label>
                                        <div className={`d-flex align-items-center ${isMobile ? "flex-wrap" : ""}`}>
                                            ...
                                            <div
                                                className={`wrapIfBox d-flex justify-content-between position-relative align-items-center flex-grow-1 pl-0 ${isMobile ? "col-12 px-0 flex-wrap mt-4" : "pr-3 mr-5"}`}>
                                                {
                                                    sensorType === SENSOR_TYPES_CONTINUES ? (
                                                        <>
                                                            <label
                                                                ...
                                                                <span className="radio-mark"/>
                                                                <span className="radio-text">{t("text.morethan")}</span>
                                                            </label>
                                                            <label
                                                                ...
                                                                <input type="radio" name="statusSensor" value="LT"
                                                                       ...
                                                                       onChange={e => setCondition(e.target.value)}/>
                                                                <span className="radio-mark"/>
                                                                <span className="radio-text">{t("text.lessthan")}</span>
                                                            </label>
                                                            <input
                                                                type="number"
                                                                value={limitPoint}
                        ...
                        <div className="row mt-4 pt-3 mx-0">
                            <div className="col-12 border rounded-12 position-relative pr-3">
                                <span className="title">{t("text.then")}</span>
                                <div className={`form-group mt-3 ${isMobile ? "" : "px-3"}`}>
                                    <label>{t("text.Relayselection")}</label>
                                    <div
                                        ...
                                        <div className={`wrapIfBox d-flex justify-content-between position-relative flex-grow-1 pl-0 ${isMobile ? "flex-wrap mt-4" : "pr-3 mr-5"}`}>
                                            <label className={`container-radio ${isMobile ? "col-6 mb-1" : ""}`}>
                        ...
                        <div className={`row mx-0 ${isMobile ? "mt-2" : "mt-3"}`}>
                            <div
                                ...
                                <div className={`row ${isMobile ? "justify-content-between" : "pl-2"}`}>
                                    <label className="container-checkbox col-lg-6 d-flex align-items-center mb-0">
                                        <input type="checkbox" name="automation" checked={delay}
                                               onChange={e => setDelay(e.target.checked)}/>
                                        <span className="checkmark"/>
                                        <span
                                    ...
                                    <div className={`col-lg-6 px-0 ${isMobile ? "col-12 mt-3" : ""}`}>
                                        <input
                                            type="number"
                                            value={delayValue}
                                            onChange={(e) => setDelayValue(e.target.value)}
                        ...
                        <div className={`row ${isMobile ? "" : "mt-4"}`}>
                            <div className={`col-12 text-left ${isMobile ? "px-3 mt-2" : "px-0 mt-3"}`}>
                                <Button
                                    ...
                                    className="p-2">{t("text.confirm")}</span></Button>
                                <Button
                                    className={`button btn-primary-fill-outline py-2 d-flex- align-items-center justify-content-center ${isMobile ? "width-35 px-4" : "px-5"}`}
                                    handler={onCancel}>
                                    <span className="p-2">{t('text.cancel')}</span>
