...
const NI = ({data, isOnline, value, interval, lastUpdated, fakeValues, graphValue, isConnected}) => {
        ...
        <div className="col-5 pl-0 d-flex align-items-center position-relative">
            <div className="d-flex align-items-center">
                ...
                <div className={`h3 mr-2 mb-0 bold ${!isOnline ? "font-24" : "font-30"}`}>
                    ...
                    <span className="h6">{value && value[value?.length - 1]?.value > 1000 && isOnline && isConnected ? "g/kg" : isOnline && isConnected ? "mg/kg" : ""}</span>
                </div>
            </div>
            {
