...
const Do = ({data, isOnline, value, lastUpdated, interval, fakeValues, graphValue, isConnected}) => {
        ...
        <div
            ...
            <div className="d-flex align-items-center">
                ...
                <div className={`h3 mr-2 mb-0 bold ${!isOnline ? "font-24" : "font-30"}`}>
                        <span className="">
                            {
                                !isOnline || !isConnected ? `${t("text.Inactive")}` : value ? value[value.length - 1].value : `${t("text.off")}`
                            }
                        </span>
                </div>
            </div>
